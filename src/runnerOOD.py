...
class Runner(object):
    def __init__(self):
        self.classes_list = ["OOD"]
        self.classes_dict = {"OOD": ['aeroplane', 'bicycle', 'boat', 'bus', 'car', 'chair', 'diningtable', 'motorbike', 'sofa', 'train']}
    ...
    def train_epoch(self, epoch, model, loader, optimizer, loss_fn, args, model_ema=None, model_swa=None,
        ...
        for batch_idx, (input, target) in enumerate(loader):
            ...
            if not args.distributed:
                ...
                acc_value = reduce_tensor(torch.tensor(acc_value).cuda(), args.world_size)
